...
### PARAMETERS ###
activationWords = ['computer', 'calcutron', 'shodan', 'showdown', 'jarvis']
...
def parseCommand():
    with noalsaerr():
        ...
        with sr.Microphone() as source:
            ...
            input_speech = listener.listen(source, timeout=5, phrase_time_limit=5)
...
if __name__ == '__main__': 
    ...
    while True:
        ...
        if query[0] in activationWords and len(query) > 1:
            ...
            # Wolfram Alpha
            if query[0] == 'compute' or query[0] == 'wolfram':
                query = ' '.join(query[1:])
                try:
